            ...
            <div className="h-[650px] flex items-center justify-center">
                <div className="h-[550px] w-[1600px] bg-black/50 rounded-3xl shadow-lg flex">
                    <div className="flex items-center">
                        {movie.poster && (
                            <img src={movie.poster} alt={movie.title} className="w-[280px] ml-14" />
                        )}
                    </div>
                    ...
                    <div className="ml-40 flex flex-col justify-center items-end space-y-6">
                        ...
                        <button className="rounded-full px-6 py-2 font-semibold text-xl text-white bg-gradient-to-r from-[#560081] via-[#5335FF] to-[#1091FB] shadow-lg hover:opacity-90 active:scale-95 transition">
                            See Showtimes
                        </button>
                    </div>
                </div>
